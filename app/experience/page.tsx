          ...
          <div className="wrap">
            ...
            <div id="tenx" className="block">
              ...
              <div className="highlight-list">
                ...
                <div className="highlight"><span className="h-dot" /><p className="h-text">Accelerated a high-priority API integration to ship in one-third its projected timeline with zero scope surprises, doubling sprint velocity and establishing the delivery model adopted across all subsequent platform initiatives.</p></div>
